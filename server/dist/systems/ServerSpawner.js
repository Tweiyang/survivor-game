...
exports.ServerSpawner = void 0;
const MonsterState_1 = require("../schema/MonsterState");
/** 怪物基础属性 */
const MONSTER_STATS = {
...
class ServerSpawner {
     ...
     */
    activateBossRoom() {
        if (this._bossRoomQueue.length === 0)
            return;
    ...
    spawnBoss(type, x, y) {
        ...
        const monster = new MonsterState_1.MonsterState();
    ...
    getAliveCount() {
        let count = 0;
        this.monsters.forEach(m => { if (m.alive)
            count++; });
        return count;
    }
    /**
...
exports.ServerSpawner = ServerSpawner;
//# sourceMappingURL=ServerSpawner.js.map