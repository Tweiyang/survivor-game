...
export class BattleScene extends Scene {
    ...
    async _loadConfigs() {
        try {
            ...
            this.monstersConfig = { slime: { name: 'Slime', maxHp: 30, attack: 5, defense: 0, moveSpeed: 60, detectionRange: 200, attackRange: 30, attackCooldown: 1.0, expValue: 10, color: '#44CC44', size: 24, shape: 'circle' } };
